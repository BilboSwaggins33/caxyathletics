...
import { getDatabase, ref, set, onValue, update, remove, push, get, child, onChildAdded, onChildRemoved } from "firebase/database";
import {
  StyleSheet,
  View,
  Text,
          ...
          <View style={styles.photoGallery}>
            {
              adminphotos.map((item, index) => (
                <View key={index} style={styles.gridView}>
                  <TouchableOpacity onPress={() => { handlePicture(item, false) }}>
          ...
          <View style={styles.photoGallery}>
            {
              photos.map((item, index) => (
                <View key={index} style={styles.gridView}>
                  <TouchableOpacity onPress={() => { handlePicture(item, true) }}>
                    <Image source={{ uri: item.uri }} style={styles.imageView} />
                  </TouchableOpacity>
                </View>
              ))
